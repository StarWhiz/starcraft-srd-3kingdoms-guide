...
Below is the full guide for the Korean 3 Kingdoms EUD Map on Starcraft Broodwar (삼랜디)
...
It helps to have your phone with google lens translate available to translate extra stuff if you are curious. I will go over the basics.
...
### Upgrades
Were you wondering what the mineral switch button was for on the psi emitter? Well it's to earn minerals for upgrades!
...
The official guide doesn't have any screenshots so you can follow my guide below for account linking if you are lost.
...
Congrats you've logged in game!

## Collecting Dailies
You can collect 200 bonus points per day you play on the website after getting to at least round 55.
...
- Typically go for 11 pulls instead of single pulls. 
- Go for single pulls if you're almost at 50 stones total stones to unlock a **mythic** or **mythic bonus** unlock just before new map release.
- Go for single pulls if you're almost done leveling up your stone reward counter, because an 11 pull would go way past the level up.
	- The why is because leveling up has better probabilities for you.
	- If you're let's say 198/200 for leveling up your stone generation. It's better to do 2 single pulls than an 11 pull in this scenario.
		- This way you unlock the better probabilities before rolling again.
